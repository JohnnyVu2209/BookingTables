...
//        btnedittable = (ImageView)findViewById(R.id.btnEditBan);
//        btndeletetable = (ImageView)findViewById(R.id.btnDeleteBan);
//
//    }
...
//
//        public MyAdapter(Context context, int layout, ArrayList<tables> BAsList) {
...
//                tvtable.setText("Tên bàn: " + mBanan.get(i).getSo_ban());
//                tvamount.setText("Số lượng người: " + mBanan.get(i).getSoluong_nguoi());
//
//            } catch (Exception e) {
//                e.printStackTrace();
//            }
...
//            ImageView edit = (ImageView) view.findViewById(R.id.btnEditBan); //BẮT SỰ KIỆN CHO EDIT
//            edit.setOnClickListener(new View.OnClickListener() {
//                @Override
//                public void onClick(View v) {
//                    final Dialog mydialog = new Dialog(DanhSachBan.this);
//                    mydialog.setContentView(R.layout.activity_sua_ban);
...
//
//
//            ImageView delete = (ImageView) view.findViewById(R.id.btnDeleteBan); //BẮT SỰ KIỆN CHO DELETE
